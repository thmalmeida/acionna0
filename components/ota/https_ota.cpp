...
// static const char *TAG_OTA = "https_ota";
...
// 	// 			ESP_LOGI(TAG_OTA, "App is valid, rollback cancelled successfully");
// 	// 		} else {
// 	// 			ESP_LOGE(TAG_OTA, "Failed to cancel rollback");
// 	// 		}
// 	// 	}
// 	// }
// // #endif
...
// 	ESP_LOGI(TAG_OTA, "esp_https_ota_perform start...");
// 	while (1) {
...
// 		// data read so far.
// 		ESP_LOGI(TAG_OTA, "Image bytes read: %d, err: %d", esp_https_ota_get_image_len_read(https_ota_handle), err);
// 	}

// 	if (esp_https_ota_is_complete_data_received(https_ota_handle) == true)
// 	{
// 		ESP_LOGI(TAG_OTA, "Complete data received!!!");
...
// {
// 	ESP_LOGI(TAG_OTA, "There is %d ota partitions", esp_ota_get_app_partition_count());
...
// 	// 			ESP_LOGI(TAG_OTA, "ESP_OTA_IMG_ABORTED");
// 	// 			break;

// 	// 			/*!< Undefined. App can boot and work without limits. */
// 	// 			case ESP_OTA_IMG_UNDEFINED:
// 	// 			ESP_LOGI(TAG_OTA, "ESP_OTA_IMG_UNDEFINED");
// 	// 			break;

// 	// 			default:
// 	// 			ESP_LOGI(TAG_OTA, "ota state: default");
// 	// 			break;
// 	// 		}
// 	// }
...
// 	if(esp_ota_get_partition_description(running, &running_app_info) == ESP_OK)
// 	{
// 		ESP_LOGI(TAG_OTA, "Running fw ver: %s", running_app_info.version);
// 		ESP_LOGI(TAG_OTA, "Date: %s", running_app_info.date);
// 	}

// 	if(esp_ota_get_partition_description(configured, &configured_app_info) == ESP_OK)
// 	{
// 		ESP_LOGI(TAG_OTA, "Boot fw ver: %s", configured_app_info.version);
// 		ESP_LOGI(TAG_OTA, "Date: %s", configured_app_info.date);
// 	}
// }